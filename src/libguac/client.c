...
guac_stream* guac_client_alloc_stream(guac_client* client) {
    ...
    stream_index = guac_pool_next_int_below(client->internal->__stream_pool, GUAC_CLIENT_MAX_STREAMS);
    if (stream_index < 0)
        return NULL;
...
void guac_client_free_stream(guac_client* client, guac_stream* stream) {
    ...
    /* Release index to pool */
    guac_pool_free_int(client->internal->__stream_pool, (freed_index - 1) / 2);
...
guac_client* guac_client_alloc() {
    ...
    guac_client_internal* internal = guac_mem_zalloc(sizeof(guac_client_internal));
    ...
    /* Initialize streams */
    client->internal->__output_streams = guac_mem_alloc(sizeof(guac_stream), GUAC_CLIENT_MAX_STREAMS);
...
void guac_client_free(guac_client* client) {
    ...
    /* Free streams */
    guac_mem_free(client->internal->__output_streams);
